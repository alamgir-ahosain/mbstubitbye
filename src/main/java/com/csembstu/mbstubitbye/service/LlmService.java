    ...
    private String buildCustomerReply(CaseType caseType, String txnId,
        ...
        if (isBangla) {
            return switch (caseType) {
                ...
                case WRONG_TRANSFER ->
                        "আপনার " + ref + " সম্পর্কে আমরা অবগত হয়েছি। " +
                                "আমাদের ডিসপুট টিম বিষয়টি পর্যালোচনা করবে এবং অফিশিয়াল চ্যানেলে আপনাকে জানাবে। " +
                                "অনুগ্রহ করে কারো সাথে আপনার পিন বা ওটিপি শেয়ার করবেন না।";

                case PAYMENT_FAILED ->
                        "আমরা লক্ষ্য করেছি যে " + ref + " এর কারণে আপনার ব্যালেন্স থেকে অর্থ কাটা গিয়ে থাকতে পারে। " +
                                "আমাদের পেমেন্টস টিম বিষয়টি যাচাই করবে এবং প্রযোজ্য ক্ষেত্রে অর্থ ফেরত দেওয়া হবে। " +
                                "অনুগ্রহ করে কারো সাথে আপনার পিন বা ওটিপি শেয়ার করবেন না।";

                case DUPLICATE_PAYMENT ->
                        "আপনার " + ref + " এর ক্ষেত্রে সম্ভাব্য ডুপ্লিকেট পেমেন্টের বিষয়টি আমরা নোট করেছি। " +
                                "আমাদের পেমেন্টস টিম বিলারের সাথে যাচাই করবে এবং প্রযোজ্য অর্থ অফিশিয়াল চ্যানেলে ফেরত দেওয়া হবে। " +
                                "অনুগ্রহ করে কারো সাথে আপনার পিন বা ওটিপি শেয়ার করবেন না।";

                case MERCHANT_SETTLEMENT_DELAY ->
                        "আপনার সেটেলমেন্ট " + ref + " সম্পর্কিত অভিযোগ আমরা নোট করেছি। " +
                                "আমাদের মার্চেন্ট অপারেশন্স টিম ব্যাচ স্ট্যাটাস যাচাই করবে এবং প্রত্যাশিত সেটেলমেন্ট সময় অফিশিয়াল চ্যানেলে জানাবে।";

                case AGENT_CASH_IN_ISSUE ->
                        "আপনার লেনদেন " + (txnId != null ? txnId : "") + " এর বিষয়ে আমরা অবগত হয়েছি। " +
                                "আমাদের এজেন্ট অপারেশন্স দল এটি দ্রুত যাচাই করবে এবং অফিশিয়াল চ্যানেলে আপনাকে জানাবে। " +
                                "অনুগ্রহ করে কারো সাথে আপনার পিন বা ওটিপি শেয়ার করবেন না।";

                case REFUND_REQUEST ->
                        "আপনার যোগাযোগের জন্য ধন্যবাদ। সম্পন্ন লেনদেনের রিফান্ড মার্চেন্টের নিজস্ব নীতির উপর নির্ভর করে। " +
                                "আমরা আপনাকে সরাসরি মার্চেন্টের সাথে যোগাযোগ করার পরামর্শ দিচ্ছি। " +
                                "সহায়তার প্রয়োজন হলে আমাদের জানান। অনুগ্রহ করে কারো সাথে আপনার পিন বা ওটিপি শেয়ার করবেন না।";

                default ->
                        "আপনার অভিযোগ সম্পর্কে আমরা অবগত হয়েছি। আমাদের দল বিষয়টি পর্যালোচনা করবে এবং অফিশিয়াল চ্যানেলে আপনাকে জানাবে। " +
                                "অনুগ্রহ করে কারো সাথে আপনার পিন বা ওটিপি শেয়ার করবেন না।";
            };
        }
